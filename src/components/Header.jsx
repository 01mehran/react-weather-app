...
export const Header = () => {
  ...
  return (
    <header className="bg-navy-light relative mx-auto flex min-h-15 w-full items-center justify-between px-4 py-2 md:bg-transparent xl:max-w-200 xl:translate-x-30 2xl:max-w-275">
      {/* Search box */}
      <SearchBox
