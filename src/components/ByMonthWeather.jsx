...
export const ByMonthWeather = ({ data }) => {
  return (
    <section>
      <main className="small:max-w-200 mx-auto flex h-full w-full max-w-125 flex-col 2xl:max-w-275">
        <div>
          {/* Weekays */}
          ...
          <section className="grid grid-cols-7 space-y-4 pb-4">
            {data.dailyForecast.map((d, i) => (
              <div
                key={i}
                className="border-lightBlue/50 flex flex-col items-center pb-4 not-nth-last-[-n+2]:border-b"
              >
