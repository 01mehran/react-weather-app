...
export const HistoryWeatherModal = ({ isHistoryOpen, toggleHistoryModal }) => {
  return (
    <>
      ...
      >
        <div className="xl:mx-auto xl:max-w-[800px] xl:translate-x-30 2xl:max-w-[1100px]">
          ...
          <main className="px-4 py-6 md:px-8 lg:px-12 lg:py-12">
            ...
            <div className="mt-4">
              ...
              <div className="text-lightBlue mt-2 flex flex-col gap-2 sm:gap-6">
